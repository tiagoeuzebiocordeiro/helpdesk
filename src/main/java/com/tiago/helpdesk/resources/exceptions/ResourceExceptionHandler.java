...
/*MANIPULADOR DE EXCEÇÕES DO NOSSO RECURSO*/
@ControllerAdvice
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> methodArgumentNotValidException(MethodArgumentNotValidException ex,
		...
		ValidationErrror errors = new ValidationErrror(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Validation Error", 
